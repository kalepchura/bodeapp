...
public final class CompraDao_Impl implements CompraDao {
  ...
  public CompraDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfCompra = new EntityInsertionAdapter<Compra>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `Compra` (`id`,`productoId`,`cantidad`,`costoUnitario`,`total`,`timestamp`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindDouble(4, entity.getCostoUnitario());
  ...
  @Override
  public Object insertCompra(final Compra compra, final Continuation<? super Long> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Long>() {
      ...
      public Long call() throws Exception {
        ...
        try {
          final Long _result = __insertionAdapterOfCompra.insertAndReturnId(compra);
  ...
  @Override
  public Object insertCompraAndIncreaseStock(final AppDatabase db, final Compra compra,
      final int cantidad, final Continuation<? super Unit> $completion) {
    return RoomDatabaseKt.withTransaction(__db, (__cont) -> CompraDao.DefaultImpls.insertCompraAndIncreaseStock(CompraDao_Impl.this, db, compra, cantidad, __cont), $completion);
  }

  @Override
  public Flow<List<Compra>> allCompras() {
    final String _sql = "SELECT * FROM Compra ORDER BY timestamp DESC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return CoroutinesRoom.createFlow(__db, false, new String[] {"Compra"}, new Callable<List<Compra>>() {
      @Override
      @NonNull
      public List<Compra> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfCostoUnitario = CursorUtil.getColumnIndexOrThrow(_cursor, "costoUnitario");
          ...
          while (_cursor.moveToNext()) {
            ...
            final double _tmpCostoUnitario;
            _tmpCostoUnitario = _cursor.getDouble(_cursorIndexOfCostoUnitario);
            ...
            _item = new Compra(_tmpId,_tmpProductoId,_tmpCantidad,_tmpCostoUnitario,_tmpTotal,_tmpTimestamp);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public Object totalPorFecha(final String fecha, final Continuation<? super Double> $completion) {
    final String _sql = "SELECT SUM(total) FROM Compra WHERE date(timestamp) = ?";
